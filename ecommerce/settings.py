...
MIDDLEWARE = [
    ...
    'whitenoise.middleware.WhiteNoiseMiddleware', # Đã thêm để phục vụ file tĩnh
...
# EMAIL_USE_TLS = True
# EMAIL_PORT = 587
# EMAIL_HOST_USER = 'trungthanhdatpro2000@gmail.com' # this email will be used to send emails
